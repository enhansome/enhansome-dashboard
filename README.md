...
* [Apache Superset](https://github.com/apache/incubator-superset) ⭐ 74,849 | 🐛 640 | 🌐 Python | 📅 2026-09-20 - a modern, enterprise-ready business intelligence web application (previously named Caravel and Panoramix).
* [Metabase](https://github.com/metabase/metabase) ⭐ 49,339 | 🐛 4,407 | 🌐 Clojure | 📅 2026-09-20 - The simplest, fastest way to get business intelligence and analytics to everyone in your company.
* [AppSmith](https://github.com/appsmithorg/appsmith) ⭐ 40,904 | 🐛 4,489 | 🌐 TypeScript | 📅 2026-09-19) - Platform to build admin panels, internal tools, and dashboards. Integrates with 25+ databases and any API.
* [Kibana](https://github.com/elasticsearch/kibana) ⭐ 21,293 | 🐛 14,609 | 🌐 TypeScript | 📅 2026-09-19 - Kibana is a browser based analytics and search interface to Logstash and other timestamped data sets stored in [ElasticSearch](http://www.elasticsearch.org/).
...
* [Xenon](https://github.com/marcimastro98/Xenon) ⭐ 83 | 🐛 1 | 🌐 JavaScript | 📅 2026-09-20 - Local all-in-one PC dashboard that runs in any browser or on the CORSAIR Xeneon Edge touchscreen: system monitor, media, mic, voice AI, a Stream-Deck grid, and RGB lighting. 100% local, no account.
...
* [StyleBI](https://github.com/inetsoft-technology/stylebi) ⭐ 54 | 🐛 15 | 🌐 Java | 📅 2026-09-20 - App for dashboards and analytics with data pipeline for transformation and mashup.
...
* [ng2 Admin](https://github.com/akveo/ng2-admin) ⭐ 25,679 | 🐛 494 | 🌐 TypeScript | 📅 2024-09-25 - Solid Angular2 admin dashboard, based on [Angular2 Webpack Starter](https://github.com/AngularClass/angular2-webpack-starter) ⭐ 10,209 | 🐛 0 | 🌐 JavaScript | 📅 2023-10-07
...
* [Hystrix Dashboard](https://github.com/Netflix-Skunkworks/hystrix-dashboard) ⭐ 232 | 🐛 10 | 🌐 JavaScript | 📅 2018-03-30 - The [Hystrix](https://github.com/Netflix/Hystrix) ⭐ 24,483 | 🐛 58 | 🌐 Java | 📅 2025-12-17 Dashboard enables realtime monitoring of Hystrix metrics.
* [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 137 | 🐛 18 | 🌐 TypeScript | 📅 2026-09-20 - AI-powered multi-cluster Kubernetes dashboard with 150+ real-time monitoring cards and CNCF integrations.
