...
* [Apache Superset](https://github.com/apache/incubator-superset) ⭐ 74,520 | 🐛 612 | 🌐 Python | 📅 2026-08-29 - a modern, enterprise-ready business intelligence web application (previously named Caravel and Panoramix).
* [Metabase](https://github.com/metabase/metabase) ⭐ 48,981 | 🐛 4,456 | 🌐 Clojure | 📅 2026-08-29 - The simplest, fastest way to get business intelligence and analytics to everyone in your company.
* [AppSmith](https://github.com/appsmithorg/appsmith) ⭐ 40,778 | 🐛 4,470 | 🌐 TypeScript | 📅 2026-08-29) - Platform to build admin panels, internal tools, and dashboards. Integrates with 25+ databases and any API.
* [Kibana](https://github.com/elasticsearch/kibana) ⭐ 21,270 | 🐛 14,308 | 🌐 TypeScript | 📅 2026-08-29 - Kibana is a browser based analytics and search interface to Logstash and other timestamped data sets stored in [ElasticSearch](http://www.elasticsearch.org/).
...
* [Xenon](https://github.com/marcimastro98/Xenon) ⭐ 71 | 🐛 4 | 🌐 JavaScript | 📅 2026-08-29 - Local all-in-one PC dashboard that runs in any browser or on the CORSAIR Xeneon Edge touchscreen: system monitor, media, mic, voice AI, a Stream-Deck grid, and RGB lighting. 100% local, no account.
...
* [StyleBI](https://github.com/inetsoft-technology/stylebi) ⭐ 54 | 🐛 28 | 🌐 Java | 📅 2026-08-29 - App for dashboards and analytics with data pipeline for transformation and mashup.
...
* [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 129 | 🐛 13 | 🌐 TypeScript | 📅 2026-08-29 - AI-powered multi-cluster Kubernetes dashboard with 150+ real-time monitoring cards and CNCF integrations.
* [Canopsis](https://github.com/capensis/canopsis) ⭐ 102 | 🐛 23 | 🌐 Go | 📅 2026-08-29 - Canopsis is an open-source hypervisor whose goal is to aggregate/consolidate information and events.
