...
* [Apache Superset](https://github.com/apache/incubator-superset) ⭐ 74,742 | 🐛 606 | 🌐 Python | 📅 2026-09-13 - a modern, enterprise-ready business intelligence web application (previously named Caravel and Panoramix).
* [Metabase](https://github.com/metabase/metabase) ⭐ 49,221 | 🐛 4,348 | 🌐 Clojure | 📅 2026-09-13 - The simplest, fastest way to get business intelligence and analytics to everyone in your company.
* [AppSmith](https://github.com/appsmithorg/appsmith) ⭐ 40,865 | 🐛 4,468 | 🌐 TypeScript | 📅 2026-09-11) - Platform to build admin panels, internal tools, and dashboards. Integrates with 25+ databases and any API.
* [Kibana](https://github.com/elasticsearch/kibana) ⭐ 21,286 | 🐛 14,761 | 🌐 TypeScript | 📅 2026-09-13 - Kibana is a browser based analytics and search interface to Logstash and other timestamped data sets stored in [ElasticSearch](http://www.elasticsearch.org/).
...
* [Xenon](https://github.com/marcimastro98/Xenon) ⭐ 79 | 🐛 4 | 🌐 JavaScript | 📅 2026-09-13 - Local all-in-one PC dashboard that runs in any browser or on the CORSAIR Xeneon Edge touchscreen: system monitor, media, mic, voice AI, a Stream-Deck grid, and RGB lighting. 100% local, no account.
...
* [ng2 Admin](https://github.com/akveo/ng2-admin) ⭐ 25,681 | 🐛 495 | 🌐 TypeScript | 📅 2024-09-25 - Solid Angular2 admin dashboard, based on [Angular2 Webpack Starter](https://github.com/AngularClass/angular2-webpack-starter) ⭐ 10,207 | 🐛 0 | 🌐 JavaScript | 📅 2023-10-07
...
* [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 135 | 🐛 143 | 🌐 TypeScript | 📅 2026-09-13 - AI-powered multi-cluster Kubernetes dashboard with 150+ real-time monitoring cards and CNCF integrations.
