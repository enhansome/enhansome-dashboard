...
* [Apache Superset](https://github.com/apache/incubator-superset) ⭐ 74,837 | 🐛 634 | 🌐 Python | 📅 2026-09-19 - a modern, enterprise-ready business intelligence web application (previously named Caravel and Panoramix).
* [Metabase](https://github.com/metabase/metabase) ⭐ 49,336 | 🐛 4,411 | 🌐 Clojure | 📅 2026-09-19 - The simplest, fastest way to get business intelligence and analytics to everyone in your company.
* [AppSmith](https://github.com/appsmithorg/appsmith) ⭐ 40,901 | 🐛 4,486 | 🌐 TypeScript | 📅 2026-09-18) - Platform to build admin panels, internal tools, and dashboards. Integrates with 25+ databases and any API.
* [Kibana](https://github.com/elasticsearch/kibana) ⭐ 21,292 | 🐛 14,616 | 🌐 TypeScript | 📅 2026-09-19 - Kibana is a browser based analytics and search interface to Logstash and other timestamped data sets stored in [ElasticSearch](http://www.elasticsearch.org/).
...
* [Xenon](https://github.com/marcimastro98/Xenon) ⭐ 83 | 🐛 1 | 🌐 JavaScript | 📅 2026-09-18 - Local all-in-one PC dashboard that runs in any browser or on the CORSAIR Xeneon Edge touchscreen: system monitor, media, mic, voice AI, a Stream-Deck grid, and RGB lighting. 100% local, no account.
...
* [StyleBI](https://github.com/inetsoft-technology/stylebi) ⭐ 53 | 🐛 16 | 🌐 Java | 📅 2026-09-19 - App for dashboards and analytics with data pipeline for transformation and mashup.
...
* [Countly](https://github.com/countly/countly-server) ⭐ 5,905 | 🐛 17 | 🌐 JavaScript | 📅 2026-09-18 - An open source, mobile & web analytics dashboard.
...
* [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 137 | 🐛 14 | 🌐 TypeScript | 📅 2026-09-19 - AI-powered multi-cluster Kubernetes dashboard with 150+ real-time monitoring cards and CNCF integrations.
* [Canopsis](https://github.com/capensis/canopsis) ⭐ 103 | 🐛 23 | 🌐 Go | 📅 2026-09-18 - Canopsis is an open-source hypervisor whose goal is to aggregate/consolidate information and events.
