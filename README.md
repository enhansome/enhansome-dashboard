...
* [Apache Superset](https://github.com/apache/incubator-superset) ⭐ 74,880 | 🐛 594 | 🌐 Python | 📅 2026-09-22 - a modern, enterprise-ready business intelligence web application (previously named Caravel and Panoramix).
* [Metabase](https://github.com/metabase/metabase) ⭐ 49,367 | 🐛 4,422 | 🌐 Clojure | 📅 2026-09-22 - The simplest, fastest way to get business intelligence and analytics to everyone in your company.
* [AppSmith](https://github.com/appsmithorg/appsmith) ⭐ 40,924 | 🐛 4,485 | 🌐 TypeScript | 📅 2026-09-21) - Platform to build admin panels, internal tools, and dashboards. Integrates with 25+ databases and any API.
* [Kibana](https://github.com/elasticsearch/kibana) ⭐ 21,295 | 🐛 14,656 | 🌐 TypeScript | 📅 2026-09-22 - Kibana is a browser based analytics and search interface to Logstash and other timestamped data sets stored in [ElasticSearch](http://www.elasticsearch.org/).
...
* [Xenon](https://github.com/marcimastro98/Xenon) ⭐ 85 | 🐛 1 | 🌐 JavaScript | 📅 2026-09-21 - Local all-in-one PC dashboard that runs in any browser or on the CORSAIR Xeneon Edge touchscreen: system monitor, media, mic, voice AI, a Stream-Deck grid, and RGB lighting. 100% local, no account.
...
* [StyleBI](https://github.com/inetsoft-technology/stylebi) ⭐ 54 | 🐛 23 | 🌐 Java | 📅 2026-09-22 - App for dashboards and analytics with data pipeline for transformation and mashup.
* [AppRankly](https://github.com/zmsp/AppRankly) ⭐ 26 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-13 - Self-hosted mobile app store analytics dashboard for iOS App Store Connect and Google Play Console.
...
* [ng2 Admin](https://github.com/akveo/ng2-admin) ⭐ 25,681 | 🐛 494 | 🌐 TypeScript | 📅 2024-09-25 - Solid Angular2 admin dashboard, based on [Angular2 Webpack Starter](https://github.com/AngularClass/angular2-webpack-starter) ⭐ 10,209 | 🐛 0 | 🌐 JavaScript | 📅 2023-10-07
* [Countly](https://github.com/countly/countly-server) ⭐ 5,906 | 🐛 18 | 🌐 JavaScript | 📅 2026-09-22 - An open source, mobile & web analytics dashboard.
...
* [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 137 | 🐛 10 | 🌐 TypeScript | 📅 2026-09-22 - AI-powered multi-cluster Kubernetes dashboard with 150+ real-time monitoring cards and CNCF integrations.
