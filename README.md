...
* [Apache Superset](https://github.com/apache/incubator-superset) ⭐ 74,535 | 🐛 606 | 🌐 Python | 📅 2026-08-30 - a modern, enterprise-ready business intelligence web application (previously named Caravel and Panoramix).
* [Metabase](https://github.com/metabase/metabase) ⭐ 48,992 | 🐛 4,451 | 🌐 Clojure | 📅 2026-08-30 - The simplest, fastest way to get business intelligence and analytics to everyone in your company.
* [AppSmith](https://github.com/appsmithorg/appsmith) ⭐ 40,785 | 🐛 4,471 | 🌐 TypeScript | 📅 2026-08-29) - Platform to build admin panels, internal tools, and dashboards. Integrates with 25+ databases and any API.
* [Kibana](https://github.com/elasticsearch/kibana) ⭐ 21,271 | 🐛 14,313 | 🌐 TypeScript | 📅 2026-08-30 - Kibana is a browser based analytics and search interface to Logstash and other timestamped data sets stored in [ElasticSearch](http://www.elasticsearch.org/).
...
* [StyleBI](https://github.com/inetsoft-technology/stylebi) ⭐ 54 | 🐛 31 | 🌐 Java | 📅 2026-08-30 - App for dashboards and analytics with data pipeline for transformation and mashup.
...
* [ng2 Admin](https://github.com/akveo/ng2-admin) ⭐ 25,694 | 🐛 495 | 🌐 TypeScript | 📅 2024-09-25 - Solid Angular2 admin dashboard, based on [Angular2 Webpack Starter](https://github.com/AngularClass/angular2-webpack-starter) ⭐ 10,209 | 🐛 0 | 🌐 JavaScript | 📅 2023-10-07
* [Countly](https://github.com/countly/countly-server) ⭐ 5,894 | 🐛 16 | 🌐 JavaScript | 📅 2026-08-29 - An open source, mobile & web analytics dashboard.
...
* [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 130 | 🐛 13 | 🌐 TypeScript | 📅 2026-08-30 - AI-powered multi-cluster Kubernetes dashboard with 150+ real-time monitoring cards and CNCF integrations.
