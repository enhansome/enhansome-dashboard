...
* [Apache Superset](https://github.com/apache/incubator-superset) ⭐ 74,483 | 🐛 636 | 🌐 Python | 📅 2026-08-27 - a modern, enterprise-ready business intelligence web application (previously named Caravel and Panoramix).
* [Metabase](https://github.com/metabase/metabase) ⭐ 48,960 | 🐛 4,498 | 🌐 Clojure | 📅 2026-08-27 - The simplest, fastest way to get business intelligence and analytics to everyone in your company.
* [AppSmith](https://github.com/appsmithorg/appsmith) ⭐ 40,755 | 🐛 4,470 | 🌐 TypeScript | 📅 2026-08-27) - Platform to build admin panels, internal tools, and dashboards. Integrates with 25+ databases and any API.
* [Kibana](https://github.com/elasticsearch/kibana) ⭐ 21,265 | 🐛 14,255 | 🌐 TypeScript | 📅 2026-08-27 - Kibana is a browser based analytics and search interface to Logstash and other timestamped data sets stored in [ElasticSearch](http://www.elasticsearch.org/).
...
* [Xenon](https://github.com/marcimastro98/Xenon) ⭐ 70 | 🐛 4 | 🌐 JavaScript | 📅 2026-08-27 - Local all-in-one PC dashboard that runs in any browser or on the CORSAIR Xeneon Edge touchscreen: system monitor, media, mic, voice AI, a Stream-Deck grid, and RGB lighting. 100% local, no account.
* [DNA Claude Analysis](https://github.com/shmlkv/dna-claude-analysis) ⭐ 56 | 🐛 0 | 🌐 Python | 📅 2026-03-04 - A personal genome analysis toolkit that generates a single-page DNA Terminal dashboard with green-on-black terminal aesthetic.
* [StyleBI](https://github.com/inetsoft-technology/stylebi) ⭐ 54 | 🐛 28 | 🌐 Java | 📅 2026-08-27 - App for dashboards and analytics with data pipeline for transformation and mashup.
...
* [ng2 Admin](https://github.com/akveo/ng2-admin) ⭐ 25,690 | 🐛 495 | 🌐 TypeScript | 📅 2024-09-25 - Solid Angular2 admin dashboard, based on [Angular2 Webpack Starter](https://github.com/AngularClass/angular2-webpack-starter) ⭐ 10,209 | 🐛 0 | 🌐 JavaScript | 📅 2023-10-07
* [Countly](https://github.com/countly/countly-server) ⭐ 5,892 | 🐛 36 | 🌐 JavaScript | 📅 2026-08-27 - An open source, mobile & web analytics dashboard.
...
* [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 128 | 🐛 50 | 🌐 TypeScript | 📅 2026-08-27 - AI-powered multi-cluster Kubernetes dashboard with 150+ real-time monitoring cards and CNCF integrations.
* [Canopsis](https://github.com/capensis/canopsis) ⭐ 102 | 🐛 23 | 🌐 Go | 📅 2026-08-26 - Canopsis is an open-source hypervisor whose goal is to aggregate/consolidate information and events.
