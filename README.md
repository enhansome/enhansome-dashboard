...
* [Apache Superset](https://github.com/apache/incubator-superset) ⭐ 74,484 | 🐛 636 | 🌐 Python | 📅 2026-08-27 - a modern, enterprise-ready business intelligence web application (previously named Caravel and Panoramix).
* [Metabase](https://github.com/metabase/metabase) ⭐ 48,963 | 🐛 4,492 | 🌐 Clojure | 📅 2026-08-27 - The simplest, fastest way to get business intelligence and analytics to everyone in your company.
* [AppSmith](https://github.com/appsmithorg/appsmith) ⭐ 40,758 | 🐛 4,470 | 🌐 TypeScript | 📅 2026-08-27) - Platform to build admin panels, internal tools, and dashboards. Integrates with 25+ databases and any API.
* [Kibana](https://github.com/elasticsearch/kibana) ⭐ 21,265 | 🐛 14,281 | 🌐 TypeScript | 📅 2026-08-27 - Kibana is a browser based analytics and search interface to Logstash and other timestamped data sets stored in [ElasticSearch](http://www.elasticsearch.org/).
...
* [StyleBI](https://github.com/inetsoft-technology/stylebi) ⭐ 54 | 🐛 14 | 🌐 Java | 📅 2026-08-27 - App for dashboards and analytics with data pipeline for transformation and mashup.
...
* [Countly](https://github.com/countly/countly-server) ⭐ 5,893 | 🐛 35 | 🌐 JavaScript | 📅 2026-08-27 - An open source, mobile & web analytics dashboard.
...
* [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 128 | 🐛 47 | 🌐 TypeScript | 📅 2026-08-27 - AI-powered multi-cluster Kubernetes dashboard with 150+ real-time monitoring cards and CNCF integrations.
