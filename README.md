...
* [Apache Superset](https://github.com/apache/incubator-superset) ⭐ 74,894 | 🐛 579 | 🌐 Python | 📅 2026-09-23 - a modern, enterprise-ready business intelligence web application (previously named Caravel and Panoramix).
* [Metabase](https://github.com/metabase/metabase) ⭐ 49,383 | 🐛 4,446 | 🌐 Clojure | 📅 2026-09-23 - The simplest, fastest way to get business intelligence and analytics to everyone in your company.
* [AppSmith](https://github.com/appsmithorg/appsmith) ⭐ 40,925 | 🐛 4,484 | 🌐 TypeScript | 📅 2026-09-23) - Platform to build admin panels, internal tools, and dashboards. Integrates with 25+ databases and any API.
* [Kibana](https://github.com/elasticsearch/kibana) ⭐ 21,297 | 🐛 14,683 | 🌐 TypeScript | 📅 2026-09-23 - Kibana is a browser based analytics and search interface to Logstash and other timestamped data sets stored in [ElasticSearch](http://www.elasticsearch.org/).
...
* [Xenon](https://github.com/marcimastro98/Xenon) ⭐ 86 | 🐛 1 | 🌐 JavaScript | 📅 2026-09-23 - Local all-in-one PC dashboard that runs in any browser or on the CORSAIR Xeneon Edge touchscreen: system monitor, media, mic, voice AI, a Stream-Deck grid, and RGB lighting. 100% local, no account.
...
* [StyleBI](https://github.com/inetsoft-technology/stylebi) ⭐ 54 | 🐛 15 | 🌐 Java | 📅 2026-09-23 - App for dashboards and analytics with data pipeline for transformation and mashup.
...
* [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 137 | 🐛 16 | 🌐 TypeScript | 📅 2026-09-23 - AI-powered multi-cluster Kubernetes dashboard with 150+ real-time monitoring cards and CNCF integrations.
