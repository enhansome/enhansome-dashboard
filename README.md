...
* [Apache Superset](https://github.com/apache/incubator-superset) ⭐ 74,368 | 🐛 618 | 🌐 Python | 📅 2026-08-22 - a modern, enterprise-ready business intelligence web application (previously named Caravel and Panoramix).
* [Metabase](https://github.com/metabase/metabase) ⭐ 48,872 | 🐛 4,393 | 🌐 Clojure | 📅 2026-08-22 - The simplest, fastest way to get business intelligence and analytics to everyone in your company.
* [AppSmith](https://github.com/appsmithorg/appsmith) ⭐ 40,718 | 🐛 4,473 | 🌐 TypeScript | 📅 2026-08-21) - Platform to build admin panels, internal tools, and dashboards. Integrates with 25+ databases and any API.
* [Kibana](https://github.com/elasticsearch/kibana) ⭐ 21,248 | 🐛 14,219 | 🌐 TypeScript | 📅 2026-08-22 - Kibana is a browser based analytics and search interface to Logstash and other timestamped data sets stored in [ElasticSearch](http://www.elasticsearch.org/).
...
* [Xenon](https://github.com/marcimastro98/Xenon) ⭐ 67 | 🐛 3 | 🌐 JavaScript | 📅 2026-08-21 - Local all-in-one PC dashboard that runs in any browser or on the CORSAIR Xeneon Edge touchscreen: system monitor, media, mic, voice AI, a Stream-Deck grid, and RGB lighting. 100% local, no account.
* [StyleBI](https://github.com/inetsoft-technology/stylebi) ⭐ 54 | 🐛 26 | 🌐 Java | 📅 2026-08-22 - App for dashboards and analytics with data pipeline for transformation and mashup.
...
* [Countly](https://github.com/countly/countly-server) ⭐ 5,889 | 🐛 86 | 🌐 JavaScript | 📅 2026-08-21 - An open source, mobile & web analytics dashboard.
* [Hystrix Dashboard](https://github.com/Netflix-Skunkworks/hystrix-dashboard) ⭐ 232 | 🐛 10 | 🌐 JavaScript | 📅 2018-03-30 - The [Hystrix](https://github.com/Netflix/Hystrix) ⭐ 24,471 | 🐛 58 | 🌐 Java | 📅 2025-12-17 Dashboard enables realtime monitoring of Hystrix metrics.
* [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 127 | 🐛 23 | 🌐 TypeScript | 📅 2026-08-22 - AI-powered multi-cluster Kubernetes dashboard with 150+ real-time monitoring cards and CNCF integrations.
