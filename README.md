...
* [Apache Superset](https://github.com/apache/incubator-superset) ⭐ 74,903 | 🐛 574 | 🌐 Python | 📅 2026-09-24 - a modern, enterprise-ready business intelligence web application (previously named Caravel and Panoramix).
* [Metabase](https://github.com/metabase/metabase) ⭐ 49,399 | 🐛 4,453 | 🌐 Clojure | 📅 2026-09-24 - The simplest, fastest way to get business intelligence and analytics to everyone in your company.
* [AppSmith](https://github.com/appsmithorg/appsmith) ⭐ 40,931 | 🐛 4,485 | 🌐 TypeScript | 📅 2026-09-24) - Platform to build admin panels, internal tools, and dashboards. Integrates with 25+ databases and any API.
* [Kibana](https://github.com/elasticsearch/kibana) ⭐ 21,301 | 🐛 14,577 | 🌐 TypeScript | 📅 2026-09-24 - Kibana is a browser based analytics and search interface to Logstash and other timestamped data sets stored in [ElasticSearch](http://www.elasticsearch.org/).
...
* [Xenon](https://github.com/marcimastro98/Xenon) ⭐ 88 | 🐛 1 | 🌐 JavaScript | 📅 2026-09-23 - Local all-in-one PC dashboard that runs in any browser or on the CORSAIR Xeneon Edge touchscreen: system monitor, media, mic, voice AI, a Stream-Deck grid, and RGB lighting. 100% local, no account.
...
* [StyleBI](https://github.com/inetsoft-technology/stylebi) ⭐ 55 | 🐛 30 | 🌐 Java | 📅 2026-09-24 - App for dashboards and analytics with data pipeline for transformation and mashup.
...
* [ng2 Admin](https://github.com/akveo/ng2-admin) ⭐ 25,681 | 🐛 496 | 🌐 TypeScript | 📅 2024-09-25 - Solid Angular2 admin dashboard, based on [Angular2 Webpack Starter](https://github.com/AngularClass/angular2-webpack-starter) ⭐ 10,209 | 🐛 0 | 🌐 JavaScript | 📅 2023-10-07
* [Countly](https://github.com/countly/countly-server) ⭐ 5,908 | 🐛 16 | 🌐 JavaScript | 📅 2026-09-23 - An open source, mobile & web analytics dashboard.
...
* [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 138 | 🐛 14 | 🌐 TypeScript | 📅 2026-09-24 - AI-powered multi-cluster Kubernetes dashboard with 150+ real-time monitoring cards and CNCF integrations.
