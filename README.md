...
* [Apache Superset](https://github.com/apache/incubator-superset) ⭐ 74,451 | 🐛 624 | 🌐 Python | 📅 2026-08-25 - a modern, enterprise-ready business intelligence web application (previously named Caravel and Panoramix).
* [Metabase](https://github.com/metabase/metabase) ⭐ 48,912 | 🐛 4,439 | 🌐 Clojure | 📅 2026-08-25 - The simplest, fastest way to get business intelligence and analytics to everyone in your company.
* [AppSmith](https://github.com/appsmithorg/appsmith) ⭐ 40,740 | 🐛 4,474 | 🌐 TypeScript | 📅 2026-08-24) - Platform to build admin panels, internal tools, and dashboards. Integrates with 25+ databases and any API.
* [Kibana](https://github.com/elasticsearch/kibana) ⭐ 21,255 | 🐛 14,239 | 🌐 TypeScript | 📅 2026-08-25 - Kibana is a browser based analytics and search interface to Logstash and other timestamped data sets stored in [ElasticSearch](http://www.elasticsearch.org/).
* [Freeboard](https://github.com/Freeboard/freeboard) ⭐ 6,503 | 🐛 166 | 🌐 JavaScript | 📅 2023-09-23 - An open source real-time dashboard builder for IOT and other web mashups.
...
* [Xenon](https://github.com/marcimastro98/Xenon) ⭐ 68 | 🐛 3 | 🌐 JavaScript | 📅 2026-08-24 - Local all-in-one PC dashboard that runs in any browser or on the CORSAIR Xeneon Edge touchscreen: system monitor, media, mic, voice AI, a Stream-Deck grid, and RGB lighting. 100% local, no account.
* [DNA Claude Analysis](https://github.com/shmlkv/dna-claude-analysis) ⭐ 55 | 🐛 0 | 🌐 Python | 📅 2026-03-04 - A personal genome analysis toolkit that generates a single-page DNA Terminal dashboard with green-on-black terminal aesthetic.
* [StyleBI](https://github.com/inetsoft-technology/stylebi) ⭐ 54 | 🐛 24 | 🌐 Java | 📅 2026-08-25 - App for dashboards and analytics with data pipeline for transformation and mashup.
...
* [ng2 Admin](https://github.com/akveo/ng2-admin) ⭐ 25,688 | 🐛 495 | 🌐 TypeScript | 📅 2024-09-25 - Solid Angular2 admin dashboard, based on [Angular2 Webpack Starter](https://github.com/AngularClass/angular2-webpack-starter) ⭐ 10,209 | 🐛 0 | 🌐 JavaScript | 📅 2023-10-07
* [Countly](https://github.com/countly/countly-server) ⭐ 5,892 | 🐛 85 | 🌐 JavaScript | 📅 2026-08-25 - An open source, mobile & web analytics dashboard.
...
* [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 127 | 🐛 48 | 🌐 TypeScript | 📅 2026-08-25 - AI-powered multi-cluster Kubernetes dashboard with 150+ real-time monitoring cards and CNCF integrations.
* [Canopsis](https://github.com/capensis/canopsis) ⭐ 102 | 🐛 23 | 🌐 Go | 📅 2026-08-25 - Canopsis is an open-source hypervisor whose goal is to aggregate/consolidate information and events.
